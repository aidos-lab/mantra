...
cat data/3_manifolds_all.txt      data/3_manifolds_10_all.txt      > data/3_manifolds.txt
cat data/3_manifolds_all_type.txt data/3_manifolds_10_all_type.txt > data/3_manifolds_type.txt
cat data/3_manifolds_all_hom.txt  data/3_manifolds_10_all_hom.txt  > data/3_manifolds_hom.txt
